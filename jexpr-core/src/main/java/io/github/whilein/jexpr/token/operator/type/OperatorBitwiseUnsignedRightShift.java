 ...
 * @author whilein
 */
public final class OperatorBitwiseUnsignedRightShift extends AbstractBinaryOperator {

    public OperatorBitwiseUnsignedRightShift() {
        super(">>>", OperatorPrecedenceConsts.BITWISE_SHIFT);
    }

    @Override
    public String toString() {
        return "BITWISE_UNSIGNED_RIGHT_SHIFT";
    }
