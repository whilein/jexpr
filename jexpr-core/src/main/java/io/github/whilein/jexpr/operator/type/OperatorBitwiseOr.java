 ...
 * @author whilein
 */
public final class OperatorBitwiseOr extends AbstractBinaryOperator {

    public OperatorBitwiseOr() {
        super("|", OperatorPrecedenceConsts.BITWISE_OR);
    }
    ...
    @Override
    public @NotNull Operand apply(boolean left, boolean right) {
