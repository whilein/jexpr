...
class NumberTokenParserTests extends AbstractTokenParserTests {
    ...
    @Test
    void parseLong() {
        assertEquals(0, update("1L"));
        assertTokens(1L);
    }

    @Test
    void parseDoubleWithSuffix() {
        assertEquals(0, update("1.1D"));
        assertTokens(1.1D);
    }

    @Test
    void parseDouble() {
        assertEquals(0, update("1.1"));
        assertTokens(1.1);
    }
    ...
    void parseLeadingPointFloat() {
        assertEquals(0, update(".1f"));
        assertTokens(.1f);
    }

    @Test
    void parseZeroDouble() {
        assertEquals(0, update("0D"));
        assertTokens(0d);
    }

    @Test
    void parseZeroFloat() {
        assertEquals(0, update("0F"));
        assertTokens(0f);
    }

    @Test
    void parseZeroLong() {
        assertEquals(0, update("0L"));
        assertTokens(0L);
    }
    ...
    void parseLeadingZeroDouble() {
        assertEquals(0, update("0.1"));
        assertTokens(0.1);
    }

    @Test
    void parseLeadingZeroFloat() {
        assertEquals(0, update("0.1f"));
        assertTokens(0.1f);
    }

    @Test
    void parseLong16() {
        assertEquals(0, update("0xaFL"));
        assertTokens(0xaFL);
    }

    @Test
    void parseInt16() {
        assertEquals(0, update("0xFa"));
        assertTokens(0xFa);
    }
    ...
    @SuppressWarnings("OctalInteger")
    void parseInt8() {
        assertEquals(0, update("0321"));
        assertTokens(0321);
    }

    @Test
    void parseLong2() {
        assertEquals(0, update("0b1010L"));
        assertTokens(0b1010L);
    }

    @Test
    void parseLeadingPointExponent() {
        assertEquals(0, update(".1e1"));
        assertTokens(.1e1);
    }

    @Test
    void parseLeadingZeroExponent() {
        assertEquals(0, update("0.1e1"));
        assertTokens(0.1e1);
    }

    @Test
    void parseExponent() {
        assertEquals(0, update("1.1e1"));
        assertTokens(1.1e1);
    }

    @Test
    void parseNegativeExponent() {
        assertEquals(0, update("1.1e-1"));
        assertTokens(1.1e-1);
    }

    @Test
    void parseInt2() {
        assertEquals(0, update("0b0101"));
        assertTokens(0b0101);
    }
