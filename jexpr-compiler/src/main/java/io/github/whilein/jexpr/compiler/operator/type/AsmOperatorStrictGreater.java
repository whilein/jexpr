 ...
 * @author whilein
 */
public final class AsmOperatorStrictGreater extends AbstractAsmOperatorCompare {
    ...
    public void compile(
        ...
        compileCompare(compiler, left, right, Opcodes.IF_ICMPLE, Opcodes.IFLE, Opcodes.DCMPL, Opcodes.FCMPL);
    }
