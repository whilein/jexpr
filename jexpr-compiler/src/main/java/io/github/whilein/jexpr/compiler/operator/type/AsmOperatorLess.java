 ...
 * @author whilein
 */
public final class AsmOperatorLess extends AbstractAsmOperatorCompare {
    ...
    public void compile(
        ...
        compileCompare(compiler, left, right, Opcodes.IF_ICMPGT, Opcodes.IFGT, Opcodes.DCMPG, Opcodes.FCMPG);
    }
