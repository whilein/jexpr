 ...
 * @author whilein
 */
public final class AsmOperatorGreater extends AbstractAsmOperatorCompare {
    ...
    public void compile(
        ...
        compileCompare(compiler, left, right, Opcodes.IF_ICMPLT, Opcodes.IFLT, Opcodes.DCMPL, Opcodes.FCMPL);
    }
