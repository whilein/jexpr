 ...
 * @author whilein
 */
public final class AsmOperatorBitwiseUnsignedRightShift extends AbstractAsmOperatorBitwiseShift {
    ...
    public void compile(
        ...
        compiler.visitInsn(compileShift(compiler, left, right).getOpcode(Opcodes.IUSHR));
    }
